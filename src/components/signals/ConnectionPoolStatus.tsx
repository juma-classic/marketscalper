                ...
                <div className="compact-header" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="status-summary">
                        ...
                        <span className="subscription-count">
                            {healthStatus.totalSubscriptions} subs
                        </span>
                    </div>
        ...
        <div className="connection-pool-status">
            <div className="pool-header">
                ...
                <div className="pool-summary">
                    <span className="summary-item">
                        ...
                        <span className="value">{healthStatus.activeConnections}/{healthStatus.totalConnections}</span>
                    </span>
                    <span className="summary-item">
                        ...
                        <div className="card-content">
                            ...
                            <div className="load-info">
                                <div className="load-header">
                                    <span>Load: {stats.subscriptions}/{stats.maxSubscriptions}</span>
                                    ...
                                    {stats.connectionStats.lastPingTime > 0 && (
                                        <div className="stat-item">
                                            ...
                                            <span className="stat-value">
                                                {Math.round((Date.now() - stats.connectionStats.lastPingTime) / 1000)}s ago
                                            </span>
                                        </div>
                                    )}
                                </div>
            ...
            <div className="pool-actions">
                <button 
                    ...
                    onClick={() => derivConnectionPool.forceReconnectAll()}
                >
                    🔄 Reconnect All
                </button>
            </div>
